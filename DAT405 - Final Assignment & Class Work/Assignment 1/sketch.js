...
var sinY;
var angle = 0;
//Sets default colour for background to black (night);
...
var a;
var c;
//Sets height for text to generate from.
var pollutionHeight = 275;
//Sets default for the amount text moves up each tick.
var speedHeight = 1;
var wordChoice;
//Sets default for incrementor to 0;
var opacityInc = 0;
var d;
...
function sun() {
  ...
  //Fills with predefined RGB values, with an opacity of 2 for the ellipse.
  fill(r,g,b,2);
